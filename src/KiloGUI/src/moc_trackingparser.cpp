...
void TrackingParser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TrackingParser *_t = static_cast<TrackingParser *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (TrackingParser::*_t)(QString );
...
const QMetaObject TrackingParser::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TrackingParser.data,
      qt_meta_data_TrackingParser,  qt_static_metacall, nullptr, nullptr}
};
