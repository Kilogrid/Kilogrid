 ...
 *  void rx_message(IR_message_t *msg, distance_measurement_t *d) {
 *      recvd_message = 1;
 *  }
 *
 *  void setup() {
 ...
 * @see IR_message_t, IR_message_crc, kilo_message_tx, kilo_message_tx_success
 */
 ...
 * value computed using the IR_message_crc() function.
 *
 * @see IR_message_t, IR_message_crc, kilo_message_tx, kilo_message_tx_success
 */
