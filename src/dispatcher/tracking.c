 ...
 */
inline void tracking_message_received(kilogrid_address_t address, uint8_t cell, tracking_user_data_t* data) {
	...
	serial_packet_tracking.items[current_tracking_index].cell = cell;
