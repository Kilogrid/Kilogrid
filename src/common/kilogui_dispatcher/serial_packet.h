...
typedef enum {
	...
	SERIAL_PACKET_CELL_FORWARD_CAN_MSG,
	SERIAL_PACKET_CELL_BOOTPAGE,
	SERIAL_PACKET_CELL_CONFIGURATION,
	SERIAL_PACKET_TRACKING,
    SERIAL_PACKET_KILO_PROGRAM_SIZE,
    SERIAL_PACKET_CELL_BOOTLOAD_START,
    SERIAL_PACKET_CELL_BOOTLOAD_GET_PAGE,
